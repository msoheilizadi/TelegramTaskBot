...
const notifyManagerCmd = require("./handlers/commands/notifyManagers");
...
bot.onText(notifyManagerCmd.pattern, (msg) => {
  notifyManagerCmd.handler(bot, msg, sessions, saveSessions);
});
